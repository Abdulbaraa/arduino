...
textSize(40);
text("FABRI creator", width-width0.875, height-height0.0277);
text("Ángulo: " + iAngle +" °", width-width0.48, height-height0.0277);
text("Dist:", width-width0.26, height-height0.0277);
if(iDistance<40) {
